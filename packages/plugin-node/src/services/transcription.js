...
export class TranscriptionService extends Service {
    ...
    constructor() {
        super();
        this.TARGET_SAMPLE_RATE = 16000; // Common sample rate for speech recognition
    ...
    detectCuda() {
        ...
        if (platform === "linux") {
            ...
            const cudaPath = path.join(settings.CUDA_PATH ||
...
TranscriptionService.serviceType = ServiceType.TRANSCRIPTION;
