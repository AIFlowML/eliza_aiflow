...
export async function validateNodeConfig(runtime) {
    try {
        ...
        const config = {
            ...
            ELEVENLABS_XI_API_KEY: runtime.getSetting("ELEVENLABS_XI_API_KEY") ||
            ...
            ...(runtime.getSetting("ELEVENLABS_XI_API_KEY") && {
                ...
                ELEVENLABS_VOICE_STABILITY: elevenlabs?.stability ||
                    process.env.ELEVENLABS_VOICE_STABILITY ||
                    "0.5",
                ELEVENLABS_VOICE_SIMILARITY_BOOST: elevenlabs?.similarityBoost ||
                    process.env.ELEVENLABS_VOICE_SIMILARITY_BOOST ||
                    "0.75",
                ELEVENLABS_VOICE_STYLE: elevenlabs?.style ||
                    process.env.ELEVENLABS_VOICE_STYLE ||
                    "0",
                ELEVENLABS_VOICE_USE_SPEAKER_BOOST: elevenlabs?.useSpeakerBoost ||
