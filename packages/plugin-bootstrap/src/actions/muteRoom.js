...
export const muteRoomAction = {
    ...
    handler: async (runtime, message) => {
        async function _shouldMute(state) {
        ...
        if (await _shouldMute(state)) {
            await runtime.databaseAdapter.setParticipantUserState(message.roomId, runtime.agentId, "MUTED");
        }
    },
    examples: [
        [
...
//# sourceMappingURL=muteRoom.js.map