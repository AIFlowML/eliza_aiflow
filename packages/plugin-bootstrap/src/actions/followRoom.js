...
export const followRoomAction = {
    ...
    handler: async (runtime, message) => {
        async function _shouldFollow(state) {
        ...
        if (await _shouldFollow(state)) {
            await runtime.databaseAdapter.setParticipantUserState(message.roomId, runtime.agentId, "FOLLOWED");
        }
    },
    examples: [
        [
...
//# sourceMappingURL=followRoom.js.map