...
` + booleanFooter;
export const unfollowRoomAction = {
    name: "UNFOLLOW_ROOM",
    similes: [
        "UNFOLLOW_CHAT",
    ...
    handler: async (runtime, message) => {
        async function _shouldUnfollow(state) {
        ...
        if (await _shouldUnfollow(state)) {
            await runtime.databaseAdapter.setParticipantUserState(message.roomId, runtime.agentId, null);
        }
    },
    examples: [
        [
...
//# sourceMappingURL=unfollowRoom.js.map