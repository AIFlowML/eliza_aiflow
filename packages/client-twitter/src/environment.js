...
export async function validateTwitterConfig(runtime) {
    try {
        const config = {
            TWITTER_DRY_RUN: runtime.getSetting("TWITTER_DRY_RUN") ||
            ...
            TWITTER_COOKIES: runtime.getSetting("TWITTER_COOKIES") ||
