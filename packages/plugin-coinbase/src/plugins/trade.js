...
import { elizaLogger, composeContext, generateObjectV2, ModelClass, } from "@ai16z/eliza";
import { executeTradeAndCharityTransfer, getWalletDetails } from "../utils";
import { tradeTemplate } from "../templates";
import { isTradeContent, TradeSchema } from "../types";
...
export const executeTradeAction = {
    name: "EXECUTE_TRADE",
