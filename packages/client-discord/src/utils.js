import { ModelClass, elizaLogger, generateText, trimTokens, parseJSONObjectFromText, } from "@ai16z/eliza";
import { ChannelType, PermissionsBitField, ThreadChannel, } from "discord.js";
export function getWavHeader(audioLength, sampleRate, channelCount = 1, bitsPerSample = 16) {
...
export async function generateSummary(runtime, text) {
...
export async function sendMessageInChunks(channel, content, inReplyTo, files) {
    const sentMessages = [];
