...
\`\`\`
`;
const getMediaAttachmentId = async (runtime, message, state) => {
...
`;
        ...
        // if text is big, let's send as an attachment
            ...
            await runtime.cacheManager.set(transcriptFilename, callbackData.text);
            await callback({
                ...callbackData,
...
//# sourceMappingURL=transcribe_media.js.map