import { stringToUuid, getEmbeddingZeroVector, composeContext, generateMessageResponse, generateShouldRespond, ModelClass, elizaLogger } from '@ai16z/eliza';
...
export class MessageManager {
    constructor(client, runtime, botUserId) {
        ...
        this.messageProcessingLock = new Set();
    ...
    async handleMessage(event) {
        ...
        try {
            ...
            try {
                ...
                let state = await this.runtime.composeState({ content, userId, agentId: this.runtime.agentId, roomId }, {
